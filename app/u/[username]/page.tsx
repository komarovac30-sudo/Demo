...
export default function PublicProfilePage() {
  ...
  return <main className="public-profile-page">
    ...
    <GuestChatPanel creatorId={p.id} displayName={p.display_name} phone={p.payment_contact_phone || p.public_phone} forceSmsOnly={Boolean(p.chat_force_sms_only)} open={chatOpen} initialMessage={chatDraft} onClose={() => { setChatOpen(false); setChatDraft(""); }}/>
